...
(function () {
  ...
  var MAP = {
    '🏘️': 'houses', '🏠': 'home', '🏡': 'home',
    '🍜': 'bowl', '🍳': 'chef-hat', '👩‍🍳': 'chef-hat', '👨‍🍳': 'chef-hat',
  ...
  var EXCLUDE = '.pill, .mood-card, .tchip, .cnd-badge-emoji, .quote-avatar, ' +
    '.loader-emoji, .phone-screen, .lb-rank, .c-tag, .try-pill, .mood-pill, .marquee-track span';
